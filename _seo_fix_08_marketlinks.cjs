 ...
 * only one or two contextual inbound links (everything else was nav boilerplate),
 * so they received almost no internal authority. This links country mentions that
 * already exist in body copy — no new copy, no layout change.
 */
const fs = require('fs');

const PLAN = [
  ['kriva-redesign.html', 'US trucking', '/markets/us'],
  ['kriva-about.html', 'United States', '/markets/us'],
  ['kriva-about.html', 'United Kingdom', '/markets/uk'],
  ['kriva-about.html', 'United Arab Emirates', '/markets/uae'],
  ['kriva-about.html', 'Canada', '/markets/ca'],
  ['kriva-case-marketplace.html', 'US trucking', '/markets/us'],
  ['kriva-insight-trucking-dispatch-crm-guide.html', 'US carriers', '/markets/us'],
  ['kriva-service-mobile-applications.html', 'US trucking', '/markets/us'],
  ['kriva-insight-saas-mvp-uk-guide.html', 'UK SaaS', '/markets/uk'],
