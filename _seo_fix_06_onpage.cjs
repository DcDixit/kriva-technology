...
const TITLES = {
 ...
 from: 'API Integration Services · Connectors &amp; Exception Queues | KRIVA', to: 'API Integration Services &amp; Connectors | KRIVA', }, 'kriva-technologies.html': {
 from: 'Technologies &amp; Stack · Figma, React, Node &amp; Integrations | KRIVA', to: 'Our Tech Stack: React, Node &amp; Integrations | KRIVA', }, };
