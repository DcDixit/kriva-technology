...
const PLAN = [
  ['kriva-solution-accounting.html', /\bUK and US entities\b/, 'UK', '/markets/uk'],
  ['kriva-solution-saas.html', /\bUK\b(?= &amp; EU payroll platform)/, null, '/markets/uk'],
  ['kriva-process.html', /\bUK\b(?= and US clients)/, null, '/markets/uk'],
  ['kriva-careers.html', /\bUK\b(?= and US client overlap)/, null, '/markets/uk'],
  ['kriva-about.html', /\bUAE\b/, null, '/markets/uae'],
];
