...
const {
 markets, indexPath, indexFile, indexTitle, indexMeta, indexEyebrow, indexH1, indexLede, } = require("./content/markets-data.cjs");
...
const VISUALS = {
 ...
 </div>`, heroSaas: `<div class="pu" role="img" aria-label="First sitting after SSO: test cycle now, roles later.">
 <div class="pu-bar">
 <div>
 ...
 </div>`, dispatch: `<div class="pu" role="img" aria-label="Dispatch SLA board: three loads with remaining time.">
 <div class="pu-bar">
 <div>
 ...
 </div>`, saas: `<div class="pu" role="img" aria-label="Empty home after signup: import records so the first sitting has work.">
 <div class="pu-bar">
 <div>
 ...
 </div>`, logistics: `<div class="pu" role="img" aria-label="Auto-transport quote: VIN, Dallas to Phoenix, enclosed, Book move.">
 <div class="pu-bar">
 <div>
 ...
 </div>`, finance: `<div class="pu" role="img" aria-label="March close: unmatched invoice against QuickBooks and bank, Resolve.">
 <div class="pu-bar">
 <div>
...
function marketBody(m) {
 ...
 return `${headBlock({
 title: m.title, meta: m.meta, canonical: ORIGIN + m.path, ogLocale: m.ogLocale, })}
...
function indexBody() {
 ...
 return `${headBlock({
 title: indexTitle, meta: indexMeta, canonical: ORIGIN + indexPath, ogLocale: "en_US", hub: true, })}
<a class="skip" href="#main">Skip to content</a>
