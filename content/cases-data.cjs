...
module.exports = {
  ...
  "cases": [
    ...
    },
    {
      ...
      "testimonial": null,
      "metricsSignedOff": false,
      "slugNote": "Slug `/work/healthtrack-mobile` confirmed in live source (`portfolio.ts` / static params). Earlier redesign notes marked the public link as TBD.",
    ...
    },
    {
      ...
      "testimonial": null,
      "metricsSignedOff": false,
      "attributionNote": "Internal · Meridian ↔ BrandLift (Anita Desai inventory link). Quote and person/company attribution omitted from public until confirmed.",
